...
Raw fish data from the FM Database is extracted and saved into a comma-separated values (CSV) file that will have a common format that you are likely familiar with.  **MORE HERE**
