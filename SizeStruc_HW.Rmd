...
1. Create a subset of data that consists of a single year for which there is a larger overall sample size in the "Fall."  [*HINT: First, make a two-way frequency table with sampling year as rows and months as columns.*]
